...
describe('/authentications endpoint', () => {
  ...
  describe('when POST /authentications', () => {
    ...
    it('should response 401 if password wrong', async () => {
      ...
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('credentials was not correct');
    });
    ...
    it('should response 400 if login payload not contain needed property', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('should send username and password');
    });
    ...
    it('should response 400 if login payload wrong data type', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('username and password should be string');
    });
  });
  ...
  describe('when PUT /authentications', () => {
    ...
    it('should return 400 payload not contain refresh token', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('should send refresh token');
    });
    ...
    it('should return 400 if refresh token not string', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('refresh token should be string');
    });
